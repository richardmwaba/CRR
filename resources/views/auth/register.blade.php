                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('first-name') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label">Firs name</label>
                        ...
                        <div class="form-group{{ $errors->has('last-name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="{{ old('last-name') }}">
                        ...
                        <div class="form-group{{ $errors->has('man-number') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" value="{{ old('man-number') }}">
