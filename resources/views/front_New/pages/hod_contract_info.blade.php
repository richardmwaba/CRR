    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="hod_home.html"><span><img src="../img/unza.png" alt="Unza logo" height="35" width="35" style="padding-bottom:5px"></span> Contract Renewal Reminder</a>
            </div>
            <!-- /.navbar-header -->
